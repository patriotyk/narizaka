...
def test_number_sentances():
    ...
    '200 тисяч британок опинилися 2002 року в лікарні через зловживання алкоголем. Кількість таких пацієнток 2010 року зросла понад удвічі.'

    assert norm('Розділ 8') == 'Розділ восьмий'
    assert norm('Ми трималися там два дні і дві ночі, 130 чоловік з 16 льюісами.') == 'Ми трималися там два дні і дві ночі, сто тридцять чоловік з шістнадцятьма льюїсами.'
